...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-tekton-2](https://github.com/jdubrick-ai/test-tekton-2)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-tekton-2-gitops](https://github.com/jdubrick-ai/test-tekton-2-gitops)

# **Usage**

To access the test-tekton-2 application that was deployed using the Software Template, complete the following instructions:
